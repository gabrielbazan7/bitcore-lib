...
var sighashForForkId = function(transaction, sighashType, inputNumber, subscript, satoshisBN) {
  ...
  function GetForkId() {
    ...
    return 79; // Bitcoin gold: https://github.com/BTCGPU/BTCGPU/pull/109/files#diff-b81dfdd8a5bd80fe9f82b5a40c4c991eR35
  };
...
function getHash (w) {
  ...
  // sighashType 
  writer.writeUInt32LE( (GetForkId()<<8)  | sighashType >>>0);
